...
import {
  useFilterBrandsForFemale,
  useFilterCategories,
  useFilterColors,
  useFilterFashinStylesForFemale,
  useFilterPrices,
  useFilterWeathers,
  type BrandNameForFemale,
  type CategoryName,
  type ColorName,
  type StyleNameForFemale,
  type WeatherName,
} from "@/store";
      ...
      >
        <View style={styles.container}>
          ...
          <View>
            ...
            <View style={styles.sectionContainer}>
              {styleOptions.map((item: StyleNameForFemale) => {
          ...
          <View>
            ...
            <View style={styles.sectionContainer}>
              {brands.map((item: BrandNameForFemale) => {
